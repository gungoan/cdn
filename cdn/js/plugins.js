        ...
        $('#AddReceiverForm').stepy({
            ...
            next: function(index) {                
                if(!$("#AddReceiverForm").validationEngine('validate')) {
                    ...
                    if($("#OrderType").val() == '1' && $("#OrderTypeDetail").val() == '15') {
						// ATM
						$('#textInfo').html('Số thẻ');
						$('#C_Account').html($("#CardNo").val());
					} else if($("#OrderType").val() == '1' && $("#OrderTypeDetail").val() != '15') {
						/// ACC
						$('#textInfo').html('Số tài khoản');
						...
						if($("#issdate").val() != "") {
							...
							if(res[0] < year) {
								noty({text: 'Please check your ID Info', layout: 'topCenter'});
								return false;
							}
						}
						$('#textInfo').html('Thông tin CMND');
						 $('#C_Account').html($("#idno").val()+ ' - Ngày cấp: '+$("#issdate").val()+' - Nơi cấp: '+$("#issplace").val());
					} else {
						// ID INFO
						if($("#issdate").val() != "") {
							var str = $("#issdate").val();
                ...
                if(!$("#EditReceiverForm").validationEngine('validate')) {
                    ...
                    if($("#OrderType").val() == '1' && $("#OrderTypeDetail").val() == '15') {
						...
						if($("#issdate").val() != "") {
						 ...
						 $('#C_Account').html($("#idno").val()+ ' - '+$("#issdate").val()+' - '+$("#issplace").val());
					} else {
						// ID INFO
						if($("#issdate").val() != "") {
							var str = $("#issdate").val();
                    ...
                    $('#C_BranchName').html($("#BranchName").val());
