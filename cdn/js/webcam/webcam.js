...
var Webcam = {
	...
	live: true,     // true when webcam is initialized and ready to snap
	...
	params: {
		...
		image_format: 'jpg',  // image format (may be jpeg or png)
		jpeg_quality: 100,      // jpeg image quality from 0 (worst) to 100 (best)
		force_flash: false,    // force flash mode,
		flip_horiz: false,     // flip image horiz (mirror mode)
		fps: 30,               // camera frames per second
		upload_name: 'myfile', // name of file in upload post data
		...
		if (this.userMedia) {
			...
			this.mediaDevices.getUserMedia({
				...
				"video": this.params.constraints || {
					...
					optional: [{
				        sourceId: this.params.videoSource
				    }]
				}
			})
